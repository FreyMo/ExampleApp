...
{
    /// <summary>
    /// DialogView type locator responsible for locating dialogView types for specified view models based
    ...
    /// 'MyNamespace.ViewModels.MyDialogViewModel' then the name of the dialogView is
    ...
    public class NamingConventionDialogTypeLocator : IDialogTypeLocator
    {
        ...
        /// <summary>
        /// Locates the dialogView type representing the specified view model in a user interface.
        /// </summary>
        /// <param name="viewModel">The view model to find the dialogView type for.</param>
        /// <returns>
        /// The dialogView type representing the specified view model in a user interface.
        /// </returns>
        public Type Locate(INotifyPropertyChanged viewModel)
        {
            ...
            if (dialogType == null)
                throw new TypeLoadException(AppendInfoAboutDialogTypeLocators($"DialogView with name '{dialogName}' is missing."));
        ...
        private static string AppendInfoAboutDialogTypeLocators(string errorMessage)
        {
            return
                ...
                "Dialogs you can always define a new convention by implementing your own dialogView " +
